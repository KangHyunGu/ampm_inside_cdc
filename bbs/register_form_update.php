...
$mb_email       = isset($_POST['mb_id']) ? trim($_POST['mb_id']) : '';						//아이디를 이메일주소로 사용 - feeris
...
if ($w == '' || $w == 'u') {
    ...
    //if ($msg = empty_mb_email($mb_email))   alert($msg, "", true, true);	//feeris
    ...
    //if ($msg = valid_mb_email($mb_email))   alert($msg, "", true, true);	//feeris
    //if ($msg = prohibit_mb_email($mb_email))alert($msg, "", true, true);	//feeris
    ...
    if ($w=='') {
        ...
        //if (get_session('ss_check_mb_id') != $mb_id || get_session('ss_check_mb_nick') != $mb_nick || get_session('ss_check_mb_email') != $mb_email) { // feeris
        if (get_session('ss_check_mb_id') != $mb_id || get_session('ss_check_mb_nick') != $mb_nick) {
            set_session('ss_check_mb_id', '');
            set_session('ss_check_mb_nick', '');
            //set_session('ss_check_mb_email', '');	//feeris
