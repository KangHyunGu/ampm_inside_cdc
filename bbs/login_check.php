...
///////////////////////////////////////////////////////////////////////
// AMPM 사원 접근인지 일반회원 접근인지를 구분한다.
// 일반회원은 기존대로 AMPM 사원은 인트라넷 정보를 통해 로그인을 진행한다.
// 소셜 로그인은 모두 일반회원으로 판단한다.
///////////////////////////////////////////////////////////////////////
$mb_ampmkey = isset($_POST['mb_ampmkey']) ? trim($_POST['mb_ampmkey']) : '';

if($mb_ampmkey && $mb_ampmkey == 'G'){
	//인트라넷 사원정보 
...
///////////////////////////////////////////////////////////////////
//AMPM 사원으로 로그인 시에는 메일인증 체크하지 않는다. - feeris
///////////////////////////////////////////////////////////////////
if($mb_ampmkey && $mb_ampmkey == 'G'){
}else{
	// 메일인증 설정이 되어 있다면
