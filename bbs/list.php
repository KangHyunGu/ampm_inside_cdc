...
///////////////////////////////////////////////////////////////////////
$marketer_search = "";
if($is_admin !='super' && $member['ampmkey'] != 'Y' && ($bo_table == 'insight' || $bo_table == 'video' || $bo_table == 'reference')){	//일반
	//숨김여부
	...
	$marketer_search.= "AND wr_17 IN({$arr_intra_id}) ";
}
///////////////////////////////////////////////////////////////////////
// 대행의뢰 게시판의 경우 - 로그인한 마케터와 담당마케터가 같은 것만 리스트한다.
// AMPM 사원인 경우
///////////////////////////////////////////////////////////////////////
if($member['ampmkey'] == 'Y' && ($bo_table == 'request')){	//마케터
	//담당마케터
	$marketer_search = " and wr_11 = '{$member['mb_id']}' ";
}
