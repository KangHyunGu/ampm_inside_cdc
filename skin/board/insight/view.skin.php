				...
				<section id="bo_v_atc">
					...
					<div id="bo_v_top">
						...
						<ul class="bo_v_com">
							...
							<?php $write_href = false;
							if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn">글쓰기</a></li><?php } ?>
							<li><a href="<?php echo $list_href ?>" class="btn_b03 btn">목록</a></li>
							<?php if ($member['ampmkey'] == 'Y') { //마케터만 보임 
							?><li class="btn_view btn"><?= codeToName($code_hide, $view['wr_19']) ?><?php } ?>
						</ul>
						<?php
