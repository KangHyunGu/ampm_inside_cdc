...
if($member['ampmkey'] != 'Y'){	//마케터 아니라면
	alert('접근권한이 없는 메뉴입니다.');
}
			...
			<section id="bo_v_atc">
				...
				<div id="bo_v_top">
					...
					<ul class="bo_v_com">
						...
						<?php if ($member['ampmkey'] == 'Y') { ?><li><a href="#" class="btn_view"><?=codeToName($code_hide, $view['wr_19'])?></a><?php } ?>
					</ul>
				   <?php
