				...
				<table>
					<tbody>
						...
						<?php for ($i = 1; $is_link && $i <= G5_LINK_COUNT; $i++) { ?>
							<tr>
								...
								<td><input type="text" name="wr_link<?php echo $i ?>" value="<?php if ($w == "u") {
																								...
																								} ?>" id="wr_link<?php echo $i ?>" class="frm_input" size="50"></td>
							</tr>
						<?php } ?>
						...
						<?php for ($i = 0; $is_file && $i < $file_count; $i++) { ?>
							<tr>
								<th scope="row">관련자료 <? // php echo $i+1 
														?></th>
								<td>
						...
						<input type="hidden" name="wr_16" id="wr_16" v-model="form.wr_16" value="<?php echo ($write['wr_16']) ? $write['wr_16'] : 'N'; ?>">  <!-- 확인여부 -->
						<input type="hidden" name="wr_17" id="wr_17" v-model="form.wr_17" value="<?php echo $write['wr_17']; ?>"> <!-- 담당아이디(노출) -->
						<input type="hidden" name="wr_18" id="wr_18" v-model="form.wr_18" value="<?php echo $write['wr_18']; ?>"> <!-- 담당이름(노출) -->
