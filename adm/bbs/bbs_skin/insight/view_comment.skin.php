...
<section id="bo_vc">
	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="left">
            <div class="pf_img"><?php echo $mb_images; ?></div>
        </div>
        ...
        <div class="right">
            <div class="cm_wrap">
                <header style="z-index:<?php echo $cmt_sv; ?>">
                    ...
                    <div><?php echo get_text($nick); ?></div>
            ...
            <div class="bo_vl_opt">
                ...
                <ul class="bo_vc_act">
                    <?php if ($list[$i]['is_reply']) { ?><li><a href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">대댓글</a></li><?php } ?>
