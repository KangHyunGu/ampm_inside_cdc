    ...
    <div class="tbl_frm01 tbl_wrap">
      ...
      <tr>
        ...
        <tr>
        	<th>담당자성함</th>
            <td colspan="5">
				<input type="text" name="wr_name" id="wr_name" class="frm_input" value="<?=$write['wr_name']?>">
			</td>
		</tr>
      <tr>
        	<th>관심매체</th>
            <td colspan="5">
				<?=codeToHtml($code_selltype, $write['wr_3'], "rdo5", "selltype")?>
			</td>
		</tr>
      <?php 
         if($write['wr_5']){
      ...
      <tr>
       ...
       <tr>
        	<th>월 예상 광고비</th>
            <td>
				<?=codeToHtml($code_monthPrice, $write['wr_2'], "rdo5", "wr_2")?>
			</td>
		</tr>
      ...
      <tr>
         <th>상세보기</th>
         <td>
            <textarea id="wr_memo" class="wr_memo"></textarea>
         </td>
      </tr>
		<!--
        <tr>
