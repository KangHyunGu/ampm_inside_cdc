...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th scope="col">번호</th>
			<th scope="col"><?php echo subject_sort_link('wr_comment', $qstr2, 1) ?>답변여부</a></th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
         ...
         <td class="td_name2">
            ...
            <?php } else {?>
            <span class="qnaIco qnaIco3">전체</span>
            <?php } ?>
         </td>
         <td class="td_hide"><?=codeToName($code_hide, $list[$i]['wr_19'])?></td>
         <td class="td_cate"><?php echo $list[$i]['ca_name'] ?></td>
			...
			<td class="td_subject">
				<div class="bo_tit">
                  ...
                  if (isset($list[$i]['icon_new'])) echo $list[$i]['icon_new'];
					   //($list[$i]['file']['count']) { echo '<'.$list[$i]['file']['count'].'>'; }
			...
			<td class="td_hide">
				<?php echo ($list[$i]['wr_12'])?$list[$i]['wr_12']:'전체' ?>
			</td>
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php $write_href=false;if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn_b02">글쓰기</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <?php } ?>
