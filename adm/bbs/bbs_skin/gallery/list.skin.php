...
<h2 id="container_title"><?php echo $board['bo_subject'] ?><span class="sound_only"> 목록</span></h2>
	<script type="text/javascript" src="<?=$board_skin_url?>/js/jquery.easing.1.3.js"></script>
<script>
...
.photo {
	...
	height:<?=$board['bo_gallery_height']?>px;
}	
...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx">
        <?php if ($is_checkbox) { ?>
        <ul class="btn_bo_adm">
            <?if($is_admin =='super'){?><li><input type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value"></li><?}?>
