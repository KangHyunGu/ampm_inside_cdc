				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="wr_link<?php echo $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?php echo $i ?>" class="frm_input" size="70" placeholder="영상과 관련링크를 입력하세요."></td>
						</tr>
						<?php } ?>
						<tr>
							<th scope="row">
							...
							<td>
								<div class="row items-start">
									<q-input outlined class="q-input" type="text" name="wr_1" v-model="form.wr_1" id="wr_1" :lazy-rules="true" :rules="mandatory('wr_1', '마케팅KPI')" size="70" maxlength="255" :dense="true" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="row items-start">
									<q-input outlined class="q-input" type="text" name="wr_2" v-model="form.wr_2" id="wr_2" :lazy-rules="true" :rules="mandatory('wr_2', '집행매체')" size="70" maxlength="255" :dense="true" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="row items-start">
									<q-input outlined class="q-input" type="text" name="wr_3" v-model="form.wr_3" id="wr_3" :lazy-rules="true" :rules="mandatory('wr_3', '집행성과')" size="70" maxlength="255" :dense="true" />
								</div>
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="wr_4">홈페이지</label></th>
							<td><input type="text" name="wr_4" value="<?=$write['wr_4']?>" id="wr_4" class="frm_input" size="70"></td>
						</tr>
						<tr>
							<th scope="row">
