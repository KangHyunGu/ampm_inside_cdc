...
<div id="sai"></div>
<h2 id="wrapper_title"><font color="#0b009d" size="3"><?php echo $board['bo_subject'] ?></font><span class="sound_only"> 목록</span></h2>
<div id="sai"></div>
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>">
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href" style="width:<?php echo $board['bo_gallery_width'] ?>px">
                    ...
                    <?php } ?>
                    <a href="<?php echo $list[$i]['href'] ?>">
                        <p align="center"><b><?php echo $list[$i]['subject'] ?></b></p>
