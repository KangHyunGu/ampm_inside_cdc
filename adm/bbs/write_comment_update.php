...
if ($is_member)
{
	...
	///////////////////////////////////////////////////////////////////////
	$wr_17 = $member['mb_id'];
	$wr_18 = addslashes(clean_xss_tags($board['bo_use_name'] ? $member['mb_name'] : $member['mb_nick']));
...
$redirect_url = short_url_clean(G5_HTTP_ADMBBS_URL.'/board.php?bo_table='.$bo_table.'&amp;wr_id='.$wr['wr_parent'].'&amp;'.$qstr.'&amp;#c_'.$comment_id);
