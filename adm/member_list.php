...
<div class="tbl_head01 tbl_wrap memberList">
   <div class="btn_top">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_id"><?php echo subject_sort_link('mb_id') ?>아이디(이메일)</a></th>
        <th scope="col" id="mb_list_mailc"><?php echo subject_sort_link('mb_email_certify', '', 'desc') ?>메일인증</a></th>
        <th scope="col" id="mb_list_sns">SNS연결계정</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_mailc" class="small"><?php echo preg_match('/[1-9]/', $row['mb_email_certify'])?'<span class="txt_true">Yes</span>':'<span class="txt_false">No</span>'; ?></td>
        <td headers="mb_list_sns" class="td_sns">
         <?php
            //소셜계정이 있다면
        ...
        <td headers="mb_list_mailr" class="small">
        ...
        <td headers="mb_list_deny" class="small">
