...
///////////////////////////////////////////////////////////////////////////////
//AMPM 사원(팀장 이상-ma_admin)의 경우 리다이렉션한다.
//admin.lib.php - 하단 권한체크에 권한 추가작업한다.
///////////////////////////////////////////////////////////////////////////////
//$sub_menu = '100000';
if($is_admin == 'ma_admin' || $is_admin == 'manager'){
	$sub_menu = '600000';
	header('Location:/adm/bbs/board.php?bo_table=insight');
	exit;
