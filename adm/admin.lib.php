...
function auth_check($auth, $attr, $return=false)
{
	...
	///////////////////////////////////////////////////////////////////////////////
	//AMPM 사원(운영자-manager)의 경우 권한에 추가한다.
	///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//AMPM 사원(팀장 이상-ma_admin)의 경우 권한에 추가한다.
//AMPM 사원(운영자-manager)의 경우 권한에 추가한다.
//AMPM 사원(CDC-uploader)의 경우 권한에 추가한다.
///////////////////////////////////////////////////////////////////////////////
}else if ($is_admin != 'super' && $is_admin != 'manager' && $is_admin != 'uploader' && $is_admin != 'ma_admin'){
