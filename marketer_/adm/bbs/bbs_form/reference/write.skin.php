...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_subject">업체(광고주)명<strong class="sound_only">필수</strong></label></th>
            <td>
		...
		<tr>
			...
			<td>
				<input type="text" name="writeday" value="<?=($write['wr_datetime'])?date("Y-m-d", strtotime($write['wr_datetime'])):""?>" id="writeday" required class="frm_input required" size="15" maxlength="15">ex)2016-03-21
			</td>
		</tr>
		-->
		<tr>
    ...
    <div class="btn_confirm">
        ...
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_b02">목록</a>
    </div>
    </form>
