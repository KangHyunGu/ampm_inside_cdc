...
if ($w == '') {
    if ($wr_id) {
        alert('글쓰기에는 \$wr_id 값을 사용하지 않습니다.', G5_MARKETER_ADMBBS_URL.'/board.php?bo_table='.$bo_table);
    }
...
//include_once(G5_MARKETER_ADMBBS_PATH.'/bbs_form/'.$board['bo_skin'].'/write.skin.php');
