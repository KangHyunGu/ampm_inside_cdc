...
define('G5_MMS_DIR',		'mms');			// SureM mms module @20160507
...
define('G5_ADMBBS_URL',     G5_URL.'/'.G5_ADMIN_DIR.'/'.G5_BBS_DIR);
...
define('G5_INCLUDE_URL',    G5_URL.'/'.G5_INCLUDE_DIR);
...
define('G5_MMS_PATH',		G5_PATH.'/'.G5_MMS_DIR);			// SureM mms module @20160507
//==============================================================================
...
if($_SERVER[REMOTE_ADDR] == "58.225.16.51" || $_SERVER[REMOTE_ADDR] == "58.225.16.52" || $_SERVER[REMOTE_ADDR] == "58.225.16.53"){
