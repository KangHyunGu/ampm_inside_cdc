...
// 최신글 추출
// $cache_time 캐시 갱신시간
function latest_popular($skin_dir='', $bo_table, $rows=10, $subject_len=40, $cache_time=1, $options='', $term='')
{
    global $g5;

	switch($term){
		case 'D': $term_time = date("Y-m-d H:i:s", G5_SERVER_TIME-3600*24); break;
		case 'W': $term_time = date("Y-m-d H:i:s", G5_SERVER_TIME-3600*24*7); break;
		case 'M': $term_time = date("Y-m-d H:i:s", G5_SERVER_TIME-3600*24*30); break;
		case 'Y': $term_time = date("Y-m-d H:i:s", G5_SERVER_TIME-3600*24*365); break;
	}
