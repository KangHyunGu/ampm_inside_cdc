...
<div class="q-gutter-md">
  ...
  <!-- //CTA배너 -->
  <!-- 동영상(15 ~ 60) -->
  <div v-if="enableVideo(wr_video_link) || video_file_info">
    <div class="title_box">
      <h3>동영상</h3>
    </div>
  ...
  <!-- //동영상(15 ~ 60) -->
  <!-- 유튜브영상 -->
  <div v-if="enableVideo(wr_youtube_link) || youtube_file_info">
    <div class="title_box">
      <h3>유튜브영상</h3>
    </div>
