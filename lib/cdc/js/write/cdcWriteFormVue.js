const app = Vue.createApp({
    ...
    methods: {
        ...
        ShowControl(index){
            const isBlog = this.form.cdc.is_blog == 'Y';
            const isInsta = this.form.cdc.is_insta == 'Y'
            if(index < 2 && (isBlog || isInsta)){
                return true;
            } else if(index >= 2 && isInsta) {
                return true;
            } else {
                return false;
            }
