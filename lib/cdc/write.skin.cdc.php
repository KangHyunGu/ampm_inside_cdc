	...
	<section class="section_left">
		...
		<div id="q-app">
			<section v-if="form" id="bo_w">
				<h2>마케팅 인사이트 글쓰기</h2>
				<q-form name="fwrite" ref="form" id="fwrite" action="<?php echo $action_url ?>" @submit.prevent="formSave" @validation-error="validationError" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
							...
							<tbody>
								...
								<tr v-if="is_category">
									...
									<td class="chk_category">
										...
										<category v-model="form.ca_name" :opts="code_category" required />
									</td>
								</tr>
									...
									<td>
										<div id="autosave_wrapper">
											...
											<div class="row items-start">
												<div>
													<q-input outlined class="q-input" type="text" name="wr_subject" v-model="form.wr_subject" id="wr_subject" :rules="mandatory('wr_subject', '제목')" size="40" maxlength="255" :dense="true" :lazy-rules="true">
												</div>
