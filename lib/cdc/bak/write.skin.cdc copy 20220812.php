					...
					<div class="tbl_frm01 tbl_wrap">
						<table>
							<tbody>
									...
									<td>
										<div class="q-pa-md">
											<div class="q-gutter-sm">
												<q-checkbox v-model="form.isBlog" label="블로그" />
												<q-checkbox v-model="form.isInsta" label="인스타" />
												<q-checkbox v-model="form.isYoutube" label="유튜브" />
											</div>
										</div>
									</td>
								</tr>
								...
								<!-- CDC-메인해쉬태그 -->
								<tr v-if="form.isBlog || form.isInsta || form.isYoutube">
