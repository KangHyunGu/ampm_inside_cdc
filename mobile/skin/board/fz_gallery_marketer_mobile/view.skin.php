...
-->
		...
		<div class="fr">
			...
			<span class="bo_v_hit"><i class="fa fa-eye"></i> <strong><?php echo number_format($view['wr_hit']) ?></strong></span> <span class="bar">|</span>
			<span class="bo_v_comment"><i class="fa fa-comments"></i> <strong><?php echo number_format($view['wr_comment']) ?></strong></span>
		</div>
		-->
            </section>
		...
		?>
                ...
                <div class="namecard">
                    <div class="ncard_head">
                        ...
                        <a id="btn_namecard" href="<?php echo G5_BBS_URL;?>/new.php?mb_id=<?=$view[mb_id]?>" class="btn_link">게시물전체보기</a>
                    </div>
    ...
    ?>
            ...
            <div id="bo_v_bot">
                <?php
        ob_start();
        $copy_href = false;$move_href = false;
		?>
                ...
                <ul class="bo_v_com">
                    <?php $update_href=false;if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="list_btn btn_edit"><i class="fa fa-rotate-right"></i> 수정</a></li><?php } ?>
                    <?php $delete_href=false;if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="list_btn btn_del" onclick="del(this.href); return false;"><i class="fa fa-remove"></i> 삭제</a></li><?php } ?>
                    <li><a href="<?php echo $list_href ?>" class="list_btn btn_list"><i class="fa fa-list"></i> 목록</a></li>
                    <?php $reply_href=false;if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="list_btn btn_reply">답변</a></li><?php } ?>
                    <?php $write_href=false;if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="list_btn btn_write"><i class="fa fa-pencil"></i> 글쓰기</a></li><?php } ?>
                </ul>
                <?php
        ...
        <script type="text/javascript">
            ...
            차감(<?php echo number_format($board['bo_download_point']) ?>점)
            ...
            *
            ...
            ($file.children(".btn_handle").hasClass("on"))
