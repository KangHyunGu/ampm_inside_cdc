...
<div class="m_contents clearfix">
	...
	<article id="bo_v" class="fz_wrap">
		...
		<section id="bo_v_info">
			...
			<div class="fr">
				<span class="bo_v_date"><i class="fa fa-calendar-check-o"><span class="sound_only">작성일</span></i> <strong><?php echo date("Y-m-d", strtotime($view['wr_datetime'])) ?></strong></span> <span class="bar">|</span>
				...
				<div class="tbl_frm01 tbl_wrap">
					<table>
						<tbody>
							<tr>
								<th>제목</th>
								<td colspan="3"><?=$view[wr_subject]?></td>
							</tr>
							<tr>
								<th>이름</th>
								<td><?=$view['wr_name']?></td>
		...
		?>
		<!-- 링크 버튼 시작 { -->
		<div class="bo_v_com" id="bo_v_bot" style="margin-bottom:8%">
				...
				<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="list_btn btn_write"><i class="fa fa-pencil"></i> 견적문의</a></li><?php } ?>
		</div>
		<!-- } 링크 버튼 끝 -->
	</article>
