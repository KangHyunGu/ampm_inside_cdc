                ...
                <div class="tbl_frm01 tbl_wrap">
                    <table>
                        <tbody>
                            ...
                            <!-- 유튜브 동영상 링크주소 -->
                            <tr>
                                <th scope="row"><label for="wr_5">영상주소</label></th>
                                <td>
                                    <input type="text" name="wr_5" value="<?php if($w=="u"){echo $write['wr_5'];} ?>" id="wr_5" class="frm_input" size="50" placeholder="내용에 출력되는 영상 링크입니다."><br />
                                    Youtube, Vimeo 동영상 공유 링크를 입력하세요. (썸네일은 자동생성 됩니다.)
                                </td>
                            </tr>

                            <tr>
                                <th scope="row"><label for="wr_content">영상설명<strong class="sound_only">필수</strong></label></th>
                                <td class="wr_content">
                            ...
                            <tr>
                                <th scope="row"><label for="wr_19">게시물 <br> 숨김 여부<strong class="sound_only">필수</strong></label></th>
                                <td>
