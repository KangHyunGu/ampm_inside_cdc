...
<section id="m_sub1">
    ...
    <div class="visual_banner">
        <img src="<?=G5_URL?>/images/sub_banner3.jpg" alt="레퍼런스 배너">
    </div>

    <!-- 금주의 인기글 슬라이드 -->
    <?php echo latest_popular("m_reference_slider", 'reference', 10, 30, 1, 'wr_hit desc', 'Y');?>
                        ...
                        <li class="gall_href">
                            ...
                            <a href="<?php echo $list[$i]['href'] ?>">
                                ...
                                <div class="gall_text_href">
                                    ...
                                    <p><?php echo cut_str(get_text( $list[$i]['subject']),10);?></p>
                                </div>
    ...
    <div class="bo_search">
        <fieldset id="bo_sch">
            ...
            <form name="fsearch" method="get">
                ...
                <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input frm_input required" size="10" maxlength="20">
