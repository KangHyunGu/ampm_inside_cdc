...
<section id="m_sub1">
		...
		<!-- 금주의 인기글 슬라이드 -->
		<?php echo latest("m_qna_slider", 'qna', 10, 36);?>
                    ...
                    <tbody>
                        ...
                        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> even">
                            ...
                            <?php } else {?>
                                ...
                                <span class="qnaIco qnaIco2">완료</span>
                                <?php } else {?>
                                <span class="qnaIco qnaIco3">대기</span>
                                <?php } ?>
                            <?php } ?>
                            </td>
            ...
            <?php if ($list_href || $is_checkbox || $write_href) { ?>
                <div class="bo_fx">
                    ...
                    <ul class="btn_bo_user">
                        ...
                        <?php if ($write_href && $member['ampmkey'] != 'Y') { ?><li><a href="<?php echo $write_href ?><?=$sublink?>" class="btn_b01 btn">글쓰기</a></li><?php } ?>
                    </ul>
                    <?php } ?>
                </div>
            <?php } ?>
		...
		<div class="bo_search">
            ...
            <select name="sfl" id="sfl">
				...
				<option value="wr_subject||wr_content||wr_18||wr_12"<?php echo get_selected($sfl, 'wr_subject||wr_content||wr_18||wr_12'); ?>>제목+내용+지정마케터</option>
            </select>
            <label for="stx" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
            <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input frm_input required" size="8" maxlength="20">
