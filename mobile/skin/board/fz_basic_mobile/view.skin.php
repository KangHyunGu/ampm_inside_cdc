...
<div class="notice_view">
    ...
    <script type="text/javascript">
        ...
        score_good = parseInt(data.count);

        var

        score_nogood = parseInt($("#txt_nogood").text());
        ...
        score_good = parseInt($("#txt_good").text());

        var

        score_nogood = parseInt(data.count);
