					...
					<tr>
						...
						<td class="td_subject">
                            <a href="<?php echo $list[$i]['href'] ?>" class="new_tit">
                                ...
                                <?php echo cut_str(get_text($list[$i]['wr_1']),15) ?>
                                <?php if ($list[$i]['icon_new']){ ?> <span class="new_icon">N<span class="sound_only">새글</span></span> <?php } ?>
                            </a>
                            <div class="bo_tit_sub_1">
                                <span class="td_media">
                                    <?=codeToName($code_selltype, ($list[$i]['wr_3'])?$list[$i]['wr_3']:'기타')?>
                                </span>
                                <!-- <span class="td_contact"><?php echo $list[$i]['wr_5'] ?></span> -->
                            </div>

                            <div class="bo_tit_sub_2">
                                <span class="td_spending"><?php echo $list[$i]['wr_2'] ?></span>
                                <div class="box">
