					...
					<tr>
                        ...
                        <td class="td_subject">
                            ...
                            <div class="bo_tit_sub_1">
                                <span class="td_media"><?=codeToName($code_selltype, $list[$i]['wr_3'])?></span>

                            </div>

                            <div class="bo_tit_sub_2">
                                <div class="box">
                                    <span class="td_name">의뢰: <?php echo $list[$i]['name'] ?></span>
                                    <span class="td_name">담당: <?php echo $list[$i]['wr_12'] ?></span>
                                </div>
