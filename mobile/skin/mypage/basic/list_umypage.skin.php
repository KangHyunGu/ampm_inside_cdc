...
?>
	...
	<section id="m_mypage">
						...
						<td class="td_subject">
                            <div class="bo_tit">
                                <a href="<?php echo $list[$i]['href'] ?>">
                                    ...
                                    <?php echo cut_str(get_text($wr_subject),15) ?>
                                    <?php
                            ...
                            <div class="bo_tit_sub_1">
                                <span class="td_name">작성: <?php echo $list[$i]['name'] ?></span>
                                <span class="td_name">담당: <?php echo ($list[$i]['wr_12'])?$list[$i]['wr_12']:'전체' ?></span>
                            </div>
                ...
                <div class="bo_fx">
                    ...
                    <ul class="btn_bo_user">
                        ...
                        <li>
                            ...
                            <?php }else{  ?>
                            <a href="<?=G5_BBS_URL?>/write.php?bo_table=qna" class="btn_b05">질문답변 글쓰기</a>
                            <?php }  ?>
        ...
        <div class="bo_search">
            ...
            <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>"  id="stx" class="sch_input2 frm_input " size="15" maxlength="20">
