    ...
    <section id="mypage">
        ...
        <div class="bo_list mp_board">
            ...
            <ul class="mp_menu">
                ...
                <li><a href="/sub/sub9-1-3.php">답변대기</a></li>
                <li><a href="/sub/sub9-1-4.php">대행의뢰</a></li>
                <li><a class="menu_on" href="/sub/sub9-1-5.php">상담현황</a></li>
				<?php } ?>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th scope="col">광고매체</th>
                    <th scope="col">연락처</th>
                    <th scope="col">월예상광고비</th>
                    <th scope="col">담당자</th>
                    <th scope="col">등록일</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="even">
                    ...
                    <td class="td_board_category">
                        <span class="qnaIco qnaIco2">접수</span>
                    </td>
                    <td class="td_w_name">
                        <a href="../sub/sub8-1-5view.php">회사명/성명</a>
                        <span class="new_icon">N<span class="sound_only">새글</span></span>
                    </td>
                    <td class="td_media">바이럴광고</td>
                    <td class="td_contact">010-1234-5678</td>
                    <td class="td_budget">500-1000만원</td>
                ...
                <tr class="even">
                    ...
                    <td class="td_board_category">
                        <span class="qnaIco qnaIco3">상담중</span>
                    </td>
                    <td class="td_w_name"><a href="../sub/sub8-1-5view.php">회사명/성명</a></td>
                    <td class="td_media">바이럴광고</td>
                    <td class="td_contact">010-1234-5678</td>
                    <td class="td_budget">500-1000만원</td>
                    <td class="td_name">홍길동</td>
                ...
                <tr class="even">
                    ...
                    <td class="td_board_category">
                        <span class="qnaIco qnaIco4">상담완료</span>
                    </td>
                    <td class="td_w_name"><a href="../sub/sub8-1-5view.php">회사명/성명</a></td>
                    <td class="td_media">바이럴광고</td>
                    <td class="td_contact">010-1234-5678</td>
