...
<div id="container">
    ...
    <section id="mypage">
        ...
        <div class="bo_list mp_board">
            ...
            <!-- 마이페이지 메뉴 -->
            <ul class="mp_menu">
                <li><a class="menu_on" href="/sub/sub9-1-1.php">내가 쓴 글</a></li>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr class="even">
                            ...
                            <td class="td_subject">
                                <a href="#">게시글 제목입니다.</a>
                                <span class="new_co_icon">N<span class="sound_only">새댓글</span></span>
                            </td>
                        ...
                        <tr class="even">
                            ...
                            <td class="td_board_category">인사이트</td>
                            <td class="td_category">구글[유튜브]</td>
                            <td class="td_s_h">미노출</td>
                            <td class="td_subject"><a href="#">가나다라마바사아자차카타파하</a></td>
                            <td class="td_w_name">홍길동</td>
                            <td class="td_name">홍길동</td>
                            <td class="td_date">2022-06-29</td>
                            <td class="td_num">0</td>
