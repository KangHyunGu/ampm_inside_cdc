    ...
    <section id="mypage">
        ...
        <div class="bo_list mp_board">
            ...
            <ul class="mp_menu">
                ...
                <li><a class="menu_on" href="/sub/sub9-1-4.php">대행의뢰</a></li>
                    ...
                    <tbody>
                        ...
                        <tr class="even">
                            ...
                            <td class="td_board_category">
                                <span class="qnaIco qnaIco3">미확인<span class="new"></span></span>
                            </td>
                            <td class="td_category">매체</td>
                            <td class="td_subject">
                                <a href="../sub/sub8-1-4view.php">게시글 제목입니다.</a>
                        ...
                        <tr class="even">
                            ...
                            <td class="td_board_category">
                            <span class="qnaIco qnaIco2">확인</span>
                            </td>
                            <td class="td_category">매체</td>
                            <td class="td_subject"><a href="../sub/sub8-1-4view.php">게시글 제목입니다.</a></td>
                            <td class="td_w_name">홍길동</td>
                            <td class="td_name">홍길동</td>
                            <td class="td_date">2022-06-29</td>
                        </tr>
