...
<?php
if (G5_IS_MOBILE) { 
    include_once(G5_MARKETER_MOBILE_PATH.'/index.php');
    return;
}
?>
<?php
...
<section id="section1">
    <div id="mk-main-visual">
        <div class="wrap">
            ...
            <div class="main-txt">
                <h5 data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-cubic">최상의 성과를 만들기 위한 <b>최고의 디지털마케팅 사업</b></h5>
...
<section id="section3">
    <div class="wrap">
        <div class="sch-box">
            <div class="sch-title" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-cubic">
                <h2>최적의 마케팅을 통해 <span class="main-color">최고의 성과를 이뤄 낼 수 있는</span><br>마케터를 찾으시나요?</h2>
            </div>
            <div class="search" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-cubic" data-aos-delay="300">
                <fieldset id="bo_sch">
    ...
    <div class="wrap" id="SectorsList">
        ...
        <div class="marketer-check">
            <div class="mk-list-tit">
                <b>다양한 분야</b>의 마케터들이 인사이트를 운영하고 있습니다.
            </div>
            <div class="mk-list-option">
                <div class="option-box" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-cubic">
            ...
            <ul class="marketer_list" data-aos="fade-up" data-aos-offset="200" data-aos-easing="ease-in-cubic" data-aos-delay="150">
                <?php
                $moreClass = '';
                $rCnt = 1;
                $iList = 0;
...
<section id="section5" data-aos="fade-up" data-aos-easing="ease-in-cubic">
    <div class="wrap">
        <div class="recruit">
            <div class="con-title">
