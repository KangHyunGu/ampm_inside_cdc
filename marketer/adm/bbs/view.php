...
if ($sca || $stx) {
    // where 문을 얻음
    $sql_search = get_sql_search($sca, $sfl, $stx, $sop);							// 검색어 조합 쿼리문
...
//마케터 개인화 용
/////////////////////////////////////////////////////////////////////////
if (($member['mb_id'] && ($member['mb_id'] == $write['mb_id'])) || $is_admin != 'mk_admin') {
...
$view = get_marketerAdmview($write, $board, $board_skin_path);
...
//include_once(G5_MARKETER_ADMBBS_PATH.'/bbs_form/'.$board['bo_skin'].'/view.skin.php');
