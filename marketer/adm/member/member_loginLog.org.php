...
$sql_common.= " INNER JOIN {$g5['mklogin_log_table']} a ON a.mb_id = b.mb_id ";
...
// 접속 기간 검색
if($fd && $td) {
	$sql_search .= " and a.loc_datetime between '".$fd." 00:00:00' and '".$td." 23:59:59' ";
}
...
<div class="local_ov01 local_ov">
    <?php echo $listall ?>
    총 수 <?php echo number_format($total_count) ?>
</div>
...
<select name="rowcount" onchange="doAction(this.value)">
	<option value="">줄수</option>
	<?=codeToHtml($list_rowCount, $rowcount, "cbo", "")?>
</select>
</form>
<?php
}
