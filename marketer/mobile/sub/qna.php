...
<section id="content" class="sub5">
    <div class="wrap">
        ...
        <a href="/mobile/ae-<?=$utm_member?>/qna/write/" class="qna_banner">
                        ...
                        <td>
                            <a href="<?=$list[$i]['href']?>">
                                <div class="board-info">
                                    <div class="inner">
                                        <span class="td_category"><?php echo $list[$i]['ca_name'] ?></span>
                                    ...
                                    <span class="td_datetime"><?php echo date("Y-m-d", strtotime($list[$i]['wr_datetime'])) ?></span>
                                </div>

                                <div class="td_subject">
                                    <?php echo cut_str(get_text( $list[$i]['subject']),20); ?>
                                    <?php
                                    ...
                                    <span class="td_name sv_use"><?php echo $list[$i]['name'] ?></span>
