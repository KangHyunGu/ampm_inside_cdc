...
//////////////////////////////////////////////////////////////////////////
//$wr_id 유무, 없으면 대표영상, 대표영상 설정도 없으면 최근 등록 1개 호출
//////////////////////////////////////////////////////////////////////////
if($wr_id){	//선택한 영상이 있다?
...
if(preg_match("/youtu/", $youtube_link)) {
	...
	$co_media = "<iframe width='100%' height='280' src='//www.youtube.com/embed/$videoId' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture'></iframe>";
	...
	$co_media = "<iframe width='100%' height='280' src='//player.vimeo.com/video/$videoId' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>";
