				...
				<div class="tbl_frm01 tbl_wrap">
					<table>
						<tbody>
							...
							<?php if ($is_category) { ?>
							<tr>
								<th scope="row"><label for="ca_name">카테고리<br>선택<strong class="sound_only">필수</strong></label></th>
							...
							<tr id="mk_appoint">
								...
								<td>
									<div class="cho-mkt">
										...
										<!-- 이름 -->                           
										<div class="cho-info"><span id="cho-name">OOO</span>를 선택하셨습니다.<br>해당 마케터에게 답변을 받아보실 수 있습니다.</div>
									</div>
								</td>
							</tr>
                            <tr>
