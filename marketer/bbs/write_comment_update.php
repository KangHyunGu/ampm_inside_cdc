    ...
    */
    ...
    $sql = " insert into $write_table
                set ca_name = '{$wr['ca_name']}',
					 ...
					 wr_ampm_user  = '{$_SESSION['ss_mb_ampm']}',
                     wr_1 = '$wr_1',
                     wr_2 = '$wr_2',
                     wr_3 = '$wr_3',
                     wr_4 = '$wr_4',
    ...
    // 원글에 댓글수 증가 & 마지막 시간 반영 & 확인여부 추가
    sql_query(" update $write_table set wr_comment = wr_comment + 1, wr_last = '".G5_TIME_YMDHIS."', wr_16 = 'Y' where wr_id = '$wr_id' ");
...
$redirect_url = short_url_clean(G5_URL."/ae-".$utm_member."/qna/".$wr['wr_parent'].'#c_'.$comment_id.'&amp;'.$qstr);
