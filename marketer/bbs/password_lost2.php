...
$strMessage = $email.' 메일로 회원아이디와 비밀번호를 인증할 수 있는 메일이 발송 되었습니다.\\n\\n메일을 확인하여 주십시오.';

//$returnUrl = "/sub/sub4-2.php?bo_table=&path_dep1=4&path_dep2=2&path_dep3=1";
$returnUrl = "/";

if($_POST['returnUrl'] == "close"){
	alert_close($strMessage, $error=true);
}else{
	echo "<script type='text/javascript'>";
	echo "window.alert('" . $strMessage . "');";
	echo "location.href='".$returnUrl."'";
	echo "</script>";

	//goto_url('/'.$returnUrl.'?bo_table='.$bo_table.'&amp;wr_id='.$wr_id.$qstr);
}
