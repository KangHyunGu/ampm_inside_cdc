...
if (G5_IS_MOBILE) { 
    include_once(G5_MARKETER_MOBILE_PATH.'/sub/qna_view.php');
    return;
}
    ...
    <div class="wrap">
        <div class="qna-wrap">
            <div class="view-title">
                ...
                <span class="vw_cate"><?php echo $view['ca_name'] ?></span>
            ...
            <div class="view-list">
                <a href="/ae-<?=$utm_member?>/qna/<?php if($team_code){ echo "&team_code=".$team_code; }?>">목록 더보기</a>
            </div>
        </div>
    </div>
</section>
