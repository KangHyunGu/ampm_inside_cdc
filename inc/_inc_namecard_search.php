...
// view 스킨용
///////////////////////////////////////////////////////////////////////
$mk = get_viewNamecardInfo($search_table[$idx], $list[$idx][$i]['wr_id']);
$mk_id = $mk['mb_id'];
$nick = $mk['nick'];
...
?>
    <!-- 마케터 프로필 네임카드 -->
    <div id="namecard_sch" class="card">
        <div class="nc_box">
            <div class="nc_inner">
                <div class="nc_img">
                    <?php echo $mb_images; ?>
            ...
            <div class="nc_btn">
               <ul>
                  ...
                  <a href="<?=$go_content?>"><li><i class="fas fa-ad"></i> 컨텐츠<br>더보기</li></a>
                  <a href="<?=$go_qna_edit?>"><li><i class="fas fa-question-circle"></i> 질문하기</li></a>
                  <a href="<?=$go_marketer?>" target="_blank"><li><i class="fas fa-house-user"></i> 마케터<br>페이지</li></a>
               </ul>
            </div>
        </div>
		<!-- 일반회원만 즐겨찾기 기능 사용 -->
